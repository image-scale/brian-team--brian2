...
- [ ] Task 5: Implement base classes for simulation objects including tracking and naming (core base + tests)
- [ ] Task 6: Implement the network that manages simulation runs with scheduling (network + tests)
