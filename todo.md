...
- [x] Task 7: Implement equation parsing that converts user-defined differential equations into usable form (equations + tests)
- [x] Task 8: Implement state variables system for neuron/synapse state storage (variables + tests)
- [x] Task 9: Implement the group base class with state variable access (group + tests)
- [x] Task 10: Implement neuron groups that define neuron dynamics with equations (neurongroup + tests)
